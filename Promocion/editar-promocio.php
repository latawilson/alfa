...
<form method="post" name="form1" action="editar_pro.php" class="form_contact">
            ...
            <div class="user_info">
                ...
                <input id="calen" type="text" name="fecha_inicio_prom" readonly="" value="<?php echo($row['fecha_inicio_prom']); ?>">
                ...
                <input name="descuento_prom" type="text" id="descuento_prom" value="<?php echo($row['descuento_prom']); ?>">
              <h2>Seleccione la imagen de la promoci&oacuten</h2>
                <input name="imagen_prom" type="file" name=" Examinar" value="<?php echo($row['imagen_prom']); ?>" >
                <input name="id_prom" type="text" value="<?php echo($row['id_prom']); ?>">
                 <input type="submit" value="Editar vergas ">
