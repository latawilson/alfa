...
<body>
   ...
   <div class="navigation-alfa1">
	<p><a href="../index_admin.php">Inicio </a> /<a href="alfarerias.php">Alfarer&iacuteas </a> / <strong>Editar Alfarer&iacutea</strong></p>
 ...
 <header>
	...
	<div class="contenedor-alfa3">
         ...
         <section >
        	<img src="../imagen_alfa/<?php echo($row['imagen_al']); ?>" width="400px" height="600px">
        </section>

<form enctype="multipart/form-data" method="post" name="form1" action="editar_alfareria.php" class="form_contact">
            <h2>Editar Alfarer&iacutea</h2>
            <div class="user_info">

                <label for="names">Nombre Alfarer&iacutea</label>
                <input style="text-transform: uppercase;"  name="nombre_al" type="text" id="names" value="<?php echo($row['nombre_al']); ?>"  maxlength="15" oninput="maxlengthNumber(this);" onkeypress="return sololetras(event)" onpaste="return false" required>

                <label for="email">Propietario</label>
                <input style="text-transform: uppercase;"name="propietario_al" type="text" id="email" value="<?php echo($row['propietario_al']); ?>" maxlength="15" oninput="maxlengthNumber(this);" onkeypress="return sololetras(event)" onpaste="return false" required>

                <label for="email">Telefono</label>
                <input name="telefono_al" type="text" id="email" value="<?php echo($row['telefono_al']); ?>"  maxlength="10" oninput="maxlengthNumber(this);" required onkeypress="return solonumeros(event)" onpaste="return false">

                <label for="phone">Direcci&oacuten</label>
                <input style="text-transform: uppercase;" name="direccion_al" type="text" id="direccion" value="<?php echo($row['direccion_al']); ?>" maxlength="100" oninput="maxlengthNumber(this);" onkeypress="return sololetras(event)" onpaste="return false" required>

                <label for="nomes">Descipci&oacuten *</label>
                 <input style="text-transform: uppercase;" name="descripcion_al" type="text" id="mensaje" value="<?php echo($row['descripcion_al']); ?>" maxlength="250" oninput="maxlengthNumber(this);" onkeypress="return sololetras(event)" onpaste="return false" required>
                
                <h2>Ingrese la Imagen de la Alfarer&iacutea</h2>
                <input name="imagen_al" type="file" name=" Examinar" value="<?php echo($row['imagen_al']); ?>">

                <input style="display:none" name="id_al" type="text" value="<?php echo($row['id_al']); ?>">
