...
<html lang="en">
  <head>
    <title>Gad La Victoria / Autoridades</title>
    <meta charset="utf-8">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/aut4.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Sr. Raul Alcides Jimenez Guerrero</h3>
                  <p class="block-38-subheading">Vicepresidente</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/aut3.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Sr. Lenin Ivan Rubio Rubio</h3>
                  <p class="block-38-subheading">Primer Vocal</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/aut4.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Sra. Josefa Cecilia Arteaga Llerena</h3>
                  <p class="block-38-subheading">Segundo Vocal</p>
                </div>
                <div class="block-38-body">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aut minima nihil sit distinctio recusandae doloribus ut fugit officia voluptate soluta. </p>
                </div>
...
<!--
    <div class="site-section block-3 site-fo">
      <div class="container">
        <div class="row justify-content-center  mb-5">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            <h2><a href="#">15% menos en todos los art&iacuteculos para tu jard&iacuten</a></h2>
            <p class="post-meta mb-4"> Febrero 3 de abril de asta 3, 2018</p>
            <p> Alfarer&iacuteas</p>
            <p><a href="#" class="btn btn-primary btn-sm">Ir a la Tienda</a></p>
          </div>
        </div>
      </div>
    </div>-->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="text">
              <h2 class="text-uppercase">Env&iacuteos</h2>
              <p>A solo cant&oacuten Pujil&iacute, env&iacuteos  fuera  y dentro de la provincia se  cobrara el envi&oacute </p>
            </div>
          </div>
