        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="alfareria.php" class="btn btn-sm btn-primary">Ir a las Alfarer&iacuteas</a>
              </p>
            </div>
          </div>
        </div>
            ...
            while($row= mysql_fetch_array($result))
            {
              ...
              <div class="item">
                <div class="block-4 text-center">
                 <center><figure class="block-4-image">
                  <img style=" height: 300px; width: 300px;" src="imagen_pro/<?php echo($row['imagen_pro']); ?>" alt="Image placeholder" class="img-fluid">
                </figure></center> 
                <div class="block-4-text p-4">
                  <h3><a href="alfa_pro2.php?id_al= <?php echo($row['alfareria_id_al']); ?>"><?php echo($row['nombre_pro']); ?></a></h3>
                  <p class="mb-0"><?php echo($row['descripcion_pro']); ?></p>
                  <p class="text-primary font-weight-bold">$ <?php echo($row['precio_pro']); ?></p>
                </div>
              </div>
            </div>
            <?php 
