...
<html lang="en">
  ...
  <body onLoad="autoImgFlip();">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a class="col-me"href="index.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black1">Jard&iacuten</strong></div>
        </div>
      </div>
    </div>  

<br>
    <div class="site-blocks-cover2 "style="background-image: url(images/dec14.jpg);" data-aos="fade">
      <div class="container">
           <FONT FACE="arial black"  SIZE=2 >
          <div class="hero-text1">
       <h1 class="mb-2">Jard&iacuten</h1>
       <p style="color: black;" class="mb-4">Podrás encontrar una gran variedad de articulo para tu <br>Jard&iacuten como artesan&iacutea, regalo, joyer&iacutea y mucho más. </p>
      </div>
      </FONT>
    </div>
    </div>
