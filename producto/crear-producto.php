...
<body>
 ...
 <header>
	...
	<div class="contenedor-alfa3">
        ...
        <form  enctype="multipart/form-data" method="post" name="form1" action="agregar_producto.php" class="form_contact">
            <h2>Producto</h2>
            <div class="user_info">
                <label for="names">Nombre producto</label>
                <input style="text-transform: uppercase;" name="nombre_pro" type="text" id="names" maxlength="30" oninput="maxlengthNumber(this);" onkeypress="return sololetras(event)" onpaste="return false" required>

                <label for="phone">Cantidad </label>
                <input name="cantidad_pro" type="number" id="direccion" maxlength="10" oninput="maxlengthNumber(this);" required onkeypress="return solonumeros(event)" onpaste="return false" required="">

                <label for="email">Tama&ntildeo del producto</label>
                <input name="tamanio_pro" type="text" id="email">

                <label for="names">Precio</label>
                <input name="precio_pro" type="text" id="names" maxlength="10" oninput="maxlengthNumber(this);" required onkeypress="return solonumeros(event)" onpaste="return false" required="">
  ...
  border-bottom:4px solid rgb(208,101,3, .7); height: 40px;" required=""  >
