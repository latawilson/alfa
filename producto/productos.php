...
<body>
   ...
   <div class="navigation-alfa1">
	...
	<a href="crear-producto.php"><p class="add"> <strong>+</strong>Agregar Nuevo Producto</p></a>
   </div>
   <br>
...
?>
			<div class="contenedor-peq">
             <div class="info1">
             <center><p class="titulo" style="text-transform: uppercase;"><?php echo($row['nombre_pro']); ?></p></center> 
            </div>
		        <div class="imagen">
		        ...
		        <div class="info">
			        ...
			        <a class="btn btn-warning btn-sm link" href="editar-producto.php?id_pro=<?php echo($row['id_pro']);?>" ><span class="glyphicon glyphicon-pencil"></span>Editar</a>
