...
<html lang="en">
  <head>
    <title>GAD la Victoria &mdash; Proposito</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a class="col-me"href="index.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black1">Prop&oacutesito </strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/vi1.jpg" alt="Image placeholder" class="img-fluid rounded">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">VISI&oacuteN </h2>
            </div>
            <FONT SIZE=4>
            <p ALIGN="justify" > La Alfarer&iacutea de la Parroquia la "Victoria" busca ser reconocida a nivel provincial y nacional con sus productos  de cerámica que tienen un buena calidad y dise&ntildeo  ya que están hechos a mano al estilo artesanal, que mantiene los formatos originales de hace un siglo y que sigue siendo una cerámica muy demandada, están enfocados al hogar o exteriores de ella. </p>
          </FONT>
          </div>
        </div>
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/mi1.jpg" alt="Image placeholder" class="img-fluid rounded">
                <a href="http://www.utc.edu.ec/" class="play-button popup-vimeo"><span class="ion-md-play"></span></a>
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">MISI&oacuteN</h2>
            </div>
              <FONT SIZE=4>
            <p ALIGN="justify"> Elaborar las mejores piezas de Barro, que  destaque entre cualquier  artesan&iacutea, a trav&eacutes de la calidad de innovaci&oacuten con alto valor agregado para el bienestar econ&oacutemico de nuestros  artesanos y sus familias.</p>     
            </FONT>       
          </div>
        </div>
      </div>
